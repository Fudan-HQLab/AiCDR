...
from models.Cdrgan.CdrganDataLoader import DataLoader, DisDataloader
from models.Cdrgan.CdrganDiscriminator import Discriminator
from models.Cdrgan.CdrganGenerator import Generator
from models.Cdrgan.CdrganReward import Reward
...
def generate_samples_gen(sess, trainable_model, batch_size, generated_num, output_file=None, get_code=True, train=0):
    # Generate Samples
#    print(f'trainable_model:{trainable_model}')
    generated_samples = []
...
class Cdrgan(Gan):
    def __init__(self, oracle=None):
        ...
        self.emb_dim = 32
        self.hidden_dim = 32
        tf.compat.v1.flags.DEFINE_string('d', '', 'kernel')
        tf.compat.v1.flags.DEFINE_string('g', '', 'kernel')
        tf.compat.v1.flags.DEFINE_string('t', '', 'kernel')
    ...
    def init_real_trainng(self, data_loc=None):
        ...
        #print(self.sequence_length, self.vocab_size)
        #25 21
        ...
        [word_index_dict, index_word_dict] = [{'a':'0','r':'1','n':'2','d':'3','c':'4','q':'5','e':'6','g':'7','h':'8','i':'9','l':'10','k':'11','m':'12','f':'13','p':'14','s':'15','t':'16','w':'17','y':'18','v':'19', 'x':20},{'0':'a','1':'r','2':'n','3':'d','4':'c','5':'q','6':'e','7':'g','8':'h','9':'i','10':'l','11':'k','12':'m','13':'f','14':'p','15':'s','16':'t','17':'w','18':'y','19':'v', '20': 'x'}]
    ...
    def train_real(self, data_loc=None):
        ...
        self.log = open('experiment-log-cdrgan-real.csv', 'w')
        print(f'self.generator:{self.generator}')
        generate_samples_gen(self.sess, self.generator, self.batch_size, self.generate_num, self.generator_file)
        print(f'self.gen_data_loader:{self.gen_data_loader}')
        ...
        ###
        saver_variables = tf.compat.v1.global_variables()
        ...
        for epoch in range(self.adversarial_epoch_num):
            ...
            saver.save(self.sess, 'cpkt/'  + f'cp_{str(epoch)}_{timestamp}')
            generate_samples_gen(self.sess, self.generator, self.batch_size, self.generate_num, self.generator_file)
            get_real_test_file()
            self.evaluate()
